...
!
  ...
  enddo
  read (12,*)
  read (12,*) tresduc, ximp, deflec, pgradf !时间残差减少因子 冲击位置 偏转角 压力梯度因子
  read (12,*)
  read (12,*)
  read (12,*) idiski, ncyc, cfl, nstep, nprint, io_type
  read (12,*)
  read (12,*)
  read (12,*) rm, retauinflow, trat, visc_type, tref_dimensional, turb_inflow !At 
  read (12,*)
  read (12,*)
  read (12,*) istat, nstat
...
!
  ...
  select case (iflow)
   ...
   case (2) ! SBLI
    ...
    ibcnr(1) = 1
   case (3) !RT
    ibc(1) = 11 ! Adiabatic wall
    ibc(2) = 11 ! Adiabatic wall
    ibc(3) = 0
    ibc(4) = 0
    ibc(5) = 0
    ibc(6) = 0
