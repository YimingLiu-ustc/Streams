...
!
  if (iflow==3) then 
    dx = rlx/(nxmax-1)
    do i=1-ng,nxmax+ng ! One extra ghost node needed for bl cases for estimation of initial wall-normal velocity by means of continuity equation
      xg(i) = (i-1)*dx-4._mykind !
    enddo
  endif
