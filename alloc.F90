...
!
  allocate(rho1bc_gpu(nymax,nzmax))
  allocate(T1bc_gpu(nymax,nzmax))
  allocate(rho2bc_gpu(nymax,nzmax))
  allocate(T2bc_gpu(nymax,nzmax))
!
#endif
!
...
!
  allocate(rho1bc(nymax,nzmax))
  allocate(rho2bc(nymax,nzmax))
  allocate(T1bc(nymax,nzmax))
  allocate(T2bc(nymax,nzmax))
!
